...
public class NLIExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("urn:sap-com:document:sap:soap:functions:mc-style^^ZstPmDataSibtc",NLIZstPmDataSibtc.class);
        classNames.put("urn:sap-com:document:sap:soap:functions:mc-style^^ZFmPmRfcWssibtcResponse",NLIZFmPmRfcWssibtcResponse.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public NLIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NLIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NLIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=String.class)) {
                java.lang.String xmlName=NLIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,NLIExtendedSoapSerializationEnvelope.class);
